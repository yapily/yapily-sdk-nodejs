...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiListResponseOfAccount', 'model/ApiResponseOfAccount'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiListResponseOfAccount'), require('../model/ApiResponseOfAccount'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.AccountsApi = factory(root.YapilyApi.ApiClient, root.YapilyApi.ApiListResponseOfAccount, root.YapilyApi.ApiResponseOfAccount);
  }
}(this, function(ApiClient, ApiListResponseOfAccount, ApiResponseOfAccount) {
  'use strict';
