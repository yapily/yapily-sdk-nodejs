...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Consent', 'model/CreateConsentApiKey', 'model/ResponseEntity'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Consent'), require('../model/CreateConsentApiKey'), require('../model/ResponseEntity'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.ConsentsApi = factory(root.YapilyApi.ApiClient, root.YapilyApi.Consent, root.YapilyApi.CreateConsentApiKey, root.YapilyApi.ResponseEntity);
  }
}(this, function(ApiClient, Consent, CreateConsentApiKey, ResponseEntity) {
  'use strict';
