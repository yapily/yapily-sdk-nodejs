...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponseOfPaymentResponse', 'model/ModelObject', 'model/SortCodePaymentRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponseOfPaymentResponse'), require('../model/ModelObject'), require('../model/SortCodePaymentRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.PaymentsApi = factory(root.YapilyApi.ApiClient, root.YapilyApi.ApiResponseOfPaymentResponse, root.YapilyApi.ModelObject, root.YapilyApi.SortCodePaymentRequest);
  }
}(this, function(ApiClient, ApiResponseOfPaymentResponse, ModelObject, SortCodePaymentRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/ModelObject} opts.userUuid user-uuid
     * @param {module:model/ModelObject} opts.callback callback
