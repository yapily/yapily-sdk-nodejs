...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createPaymentUsingPUT operation.
     * @callback module:api/TransfersApi~createPaymentUsingPUTCallback
     ...
     * @param {Boolean} opts.raw raw
     * @param {module:api/TransfersApi~createPaymentUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiResponseOfTransferResponse}
     */
    this.createPaymentUsingPUT = function(consent, accountId, opts, callback) {
      opts = opts || {};
      var postBody = opts['transferRequest'];

      // verify the required parameter 'consent' is set
      if (consent === undefined || consent === null) {
        throw new Error("Missing the required parameter 'consent' when calling createPaymentUsingPUT");
      }

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling createPaymentUsingPUT");
      }
