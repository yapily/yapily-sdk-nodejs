...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.YapilyApi.SortCodePaymentRequest = factory(root.YapilyApi.ApiClient);
  }
   ...
   */
  var exports = function(senderAccountId, name, amount, currency, reference, country, accountNumber, sortCode) {
    var _this = this;

    _this['senderAccountId'] = senderAccountId;
    _this['name'] = name;
    _this['amount'] = amount;
