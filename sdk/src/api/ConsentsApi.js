...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * Get consents
     * @param {Object} opts Optional parameters
     * @param {String} opts.filterApplicationUserId Filter consents by applicationUserId
     * @param {String} opts.filterUserUuid Filter consents by userUuid
     * @param {String} opts.filterInstitution Use this parameter to filter consent by institution, using the Yapily institution Id
    ...
    this.getConsentsUsingGET = function(opts, callback) {
      ...
      var queryParams = {
        'filter[applicationUserId]': opts['filterApplicationUserId'],
        'filter[userUuid]': opts['filterUserUuid'],
