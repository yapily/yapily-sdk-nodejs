...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createPaymentInitiationUsingPOST = function(paymentAuthRequest, callback) {
      ...
      if (paymentAuthRequest === undefined || paymentAuthRequest === null) {
        throw new Error("Missing the required parameter 'paymentAuthRequest' when calling createPaymentInitiationUsingPOST");
      }
