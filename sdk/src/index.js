...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ATMMapServiceLinks', 'model/ATMOpenData', 'model/ATMOpenDataBrand', 'model/ATMOpenDataResponse', 'model/Account', 'model/AccountAuthorisationRequest', 'model/AccountBalance', 'model/AccountIdentification', 'model/AccountName', 'model/AccountRequest', 'model/AccountStatement', 'model/Address', 'model/AddressDetails', 'model/AgeEligibility', 'model/Amount', 'model/ApiListResponseOfAccount', 'model/ApiListResponseOfAccountStatement', 'model/ApiListResponseOfConsent', 'model/ApiListResponseOfFeatureDetails', 'model/ApiListResponseOfInstitution', 'model/ApiListResponseOfTransaction', 'model/ApiResponseOfAccount', 'model/ApiResponseOfAccountStatement', 'model/ApiResponseOfAuthorisationRequestResponse', 'model/ApiResponseOfConsent', 'model/ApiResponseOfConsentDeleteResponse', 'model/ApiResponseOfIdentity', 'model/ApiResponseOfListOfATMOpenDataResponse', 'model/ApiResponseOfListOfPersonalCurrentAccountData', 'model/ApiResponseOfPaymentResponse', 'model/ApiResponseOfTransferResponse', 'model/ApiResponseOfUserDeleteResponse', 'model/Application', 'model/ApplicationUser', 'model/AuthorisationRequestResponse', 'model/Balance', 'model/Branch', 'model/ChargeDetails', 'model/Consent', 'model/ConsentAuthCodeRequest', 'model/ConsentDeleteResponse', 'model/CoreProduct', 'model/Country', 'model/CreateConsentAccessToken', 'model/CreditCheck', 'model/CreditInterest', 'model/CreditInterestCreditInterestEligibility', 'model/CreditInterestTierBand', 'model/CreditInterestTierBandSet', 'model/CreditLine', 'model/CurrencyExchange', 'model/Eligibility', 'model/EligibilityOtherEligibility', 'model/FeatureDetails', 'model/File', 'model/FilterAndSort', 'model/GeoLocation1', 'model/GeographicCoordinates1', 'model/IDVerificationCheck', 'model/Identity', 'model/IdentityAddress', 'model/InlineResponse2001ATM', 'model/InlineResponse2001OtherATMServices', 'model/InlineResponse2001OtherAccessibility', 'model/InputStream', 'model/InputStreamResource', 'model/Institution', 'model/InstitutionConsent', 'model/IsoBankTransactionCode', 'model/IsoCodeDetails', 'model/Location', 'model/LocationOtherLocationCategory', 'model/Media', 'model/Merchant', 'model/MerchantInfo', 'model/MonitoringFeatureStatus', 'model/NewApplicationUser', 'model/Next', 'model/OneTimeTokenRequest', 'model/OtherApplicationFrequency', 'model/OtherBankInterestType', 'model/OtherCalculationFrequency', 'model/OtherFeeRateType', 'model/OtherFeeType', 'model/OtherResidencyType', 'model/OtherType', 'model/Overdraft', 'model/OverdraftOtherFeeType', 'model/OverdraftOverdraftFeeChargeCap', 'model/OverdraftOverdraftFeeChargeDetail', 'model/OverdraftOverdraftFeesCharges', 'model/OverdraftOverdraftFeesCharges1', 'model/OverdraftOverdraftTierBand', 'model/OverdraftOverdraftTierBandSet', 'model/Pagination', 'model/Payee', 'model/PaymentResponse', 'model/PaymentStatusDetails', 'model/PersonalCurrentAccountBrand', 'model/PersonalCurrentAccountData', 'model/PersonalCurrentAccountPCA', 'model/PersonalCurrentAccountPCAMarketingState', 'model/PostalAddress1', 'model/ProprietaryBankTransactionCode', 'model/ResidencyEligibility', 'model/ResponseEntity', 'model/ResponseListMeta', 'model/ResponseMeta', 'model/Site', 'model/SortCodePaymentAuthRequest', 'model/SortCodePaymentRequest', 'model/StatementReference', 'model/Transaction', 'model/TransferRequest', 'model/TransferResponse', 'model/URI', 'model/URL', 'model/UserDeleteResponse', 'model/YapilyAccessToken', 'api/AccountsApi', 'api/ApplicationUsersApi', 'api/ApplicationsApi', 'api/ConsentsApi', 'api/IdentityApi', 'api/InstitutionsApi', 'api/InstitutionsOpenDataApi', 'api/OAuthApi', 'api/PaymentsApi', 'api/StatementsApi', 'api/TransactionsApi', 'api/TransfersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ATMMapServiceLinks'), require('./model/ATMOpenData'), require('./model/ATMOpenDataBrand'), require('./model/ATMOpenDataResponse'), require('./model/Account'), require('./model/AccountAuthorisationRequest'), require('./model/AccountBalance'), require('./model/AccountIdentification'), require('./model/AccountName'), require('./model/AccountRequest'), require('./model/AccountStatement'), require('./model/Address'), require('./model/AddressDetails'), require('./model/AgeEligibility'), require('./model/Amount'), require('./model/ApiListResponseOfAccount'), require('./model/ApiListResponseOfAccountStatement'), require('./model/ApiListResponseOfConsent'), require('./model/ApiListResponseOfFeatureDetails'), require('./model/ApiListResponseOfInstitution'), require('./model/ApiListResponseOfTransaction'), require('./model/ApiResponseOfAccount'), require('./model/ApiResponseOfAccountStatement'), require('./model/ApiResponseOfAuthorisationRequestResponse'), require('./model/ApiResponseOfConsent'), require('./model/ApiResponseOfConsentDeleteResponse'), require('./model/ApiResponseOfIdentity'), require('./model/ApiResponseOfListOfATMOpenDataResponse'), require('./model/ApiResponseOfListOfPersonalCurrentAccountData'), require('./model/ApiResponseOfPaymentResponse'), require('./model/ApiResponseOfTransferResponse'), require('./model/ApiResponseOfUserDeleteResponse'), require('./model/Application'), require('./model/ApplicationUser'), require('./model/AuthorisationRequestResponse'), require('./model/Balance'), require('./model/Branch'), require('./model/ChargeDetails'), require('./model/Consent'), require('./model/ConsentAuthCodeRequest'), require('./model/ConsentDeleteResponse'), require('./model/CoreProduct'), require('./model/Country'), require('./model/CreateConsentAccessToken'), require('./model/CreditCheck'), require('./model/CreditInterest'), require('./model/CreditInterestCreditInterestEligibility'), require('./model/CreditInterestTierBand'), require('./model/CreditInterestTierBandSet'), require('./model/CreditLine'), require('./model/CurrencyExchange'), require('./model/Eligibility'), require('./model/EligibilityOtherEligibility'), require('./model/FeatureDetails'), require('./model/File'), require('./model/FilterAndSort'), require('./model/GeoLocation1'), require('./model/GeographicCoordinates1'), require('./model/IDVerificationCheck'), require('./model/Identity'), require('./model/IdentityAddress'), require('./model/InlineResponse2001ATM'), require('./model/InlineResponse2001OtherATMServices'), require('./model/InlineResponse2001OtherAccessibility'), require('./model/InputStream'), require('./model/InputStreamResource'), require('./model/Institution'), require('./model/InstitutionConsent'), require('./model/IsoBankTransactionCode'), require('./model/IsoCodeDetails'), require('./model/Location'), require('./model/LocationOtherLocationCategory'), require('./model/Media'), require('./model/Merchant'), require('./model/MerchantInfo'), require('./model/MonitoringFeatureStatus'), require('./model/NewApplicationUser'), require('./model/Next'), require('./model/OneTimeTokenRequest'), require('./model/OtherApplicationFrequency'), require('./model/OtherBankInterestType'), require('./model/OtherCalculationFrequency'), require('./model/OtherFeeRateType'), require('./model/OtherFeeType'), require('./model/OtherResidencyType'), require('./model/OtherType'), require('./model/Overdraft'), require('./model/OverdraftOtherFeeType'), require('./model/OverdraftOverdraftFeeChargeCap'), require('./model/OverdraftOverdraftFeeChargeDetail'), require('./model/OverdraftOverdraftFeesCharges'), require('./model/OverdraftOverdraftFeesCharges1'), require('./model/OverdraftOverdraftTierBand'), require('./model/OverdraftOverdraftTierBandSet'), require('./model/Pagination'), require('./model/Payee'), require('./model/PaymentResponse'), require('./model/PaymentStatusDetails'), require('./model/PersonalCurrentAccountBrand'), require('./model/PersonalCurrentAccountData'), require('./model/PersonalCurrentAccountPCA'), require('./model/PersonalCurrentAccountPCAMarketingState'), require('./model/PostalAddress1'), require('./model/ProprietaryBankTransactionCode'), require('./model/ResidencyEligibility'), require('./model/ResponseEntity'), require('./model/ResponseListMeta'), require('./model/ResponseMeta'), require('./model/Site'), require('./model/SortCodePaymentAuthRequest'), require('./model/SortCodePaymentRequest'), require('./model/StatementReference'), require('./model/Transaction'), require('./model/TransferRequest'), require('./model/TransferResponse'), require('./model/URI'), require('./model/URL'), require('./model/UserDeleteResponse'), require('./model/YapilyAccessToken'), require('./api/AccountsApi'), require('./api/ApplicationUsersApi'), require('./api/ApplicationsApi'), require('./api/ConsentsApi'), require('./api/IdentityApi'), require('./api/InstitutionsApi'), require('./api/InstitutionsOpenDataApi'), require('./api/OAuthApi'), require('./api/PaymentsApi'), require('./api/StatementsApi'), require('./api/TransactionsApi'), require('./api/TransfersApi'));
  }
}(function(ApiClient, ATMMapServiceLinks, ATMOpenData, ATMOpenDataBrand, ATMOpenDataResponse, Account, AccountAuthorisationRequest, AccountBalance, AccountIdentification, AccountName, AccountRequest, AccountStatement, Address, AddressDetails, AgeEligibility, Amount, ApiListResponseOfAccount, ApiListResponseOfAccountStatement, ApiListResponseOfConsent, ApiListResponseOfFeatureDetails, ApiListResponseOfInstitution, ApiListResponseOfTransaction, ApiResponseOfAccount, ApiResponseOfAccountStatement, ApiResponseOfAuthorisationRequestResponse, ApiResponseOfConsent, ApiResponseOfConsentDeleteResponse, ApiResponseOfIdentity, ApiResponseOfListOfATMOpenDataResponse, ApiResponseOfListOfPersonalCurrentAccountData, ApiResponseOfPaymentResponse, ApiResponseOfTransferResponse, ApiResponseOfUserDeleteResponse, Application, ApplicationUser, AuthorisationRequestResponse, Balance, Branch, ChargeDetails, Consent, ConsentAuthCodeRequest, ConsentDeleteResponse, CoreProduct, Country, CreateConsentAccessToken, CreditCheck, CreditInterest, CreditInterestCreditInterestEligibility, CreditInterestTierBand, CreditInterestTierBandSet, CreditLine, CurrencyExchange, Eligibility, EligibilityOtherEligibility, FeatureDetails, File, FilterAndSort, GeoLocation1, GeographicCoordinates1, IDVerificationCheck, Identity, IdentityAddress, InlineResponse2001ATM, InlineResponse2001OtherATMServices, InlineResponse2001OtherAccessibility, InputStream, InputStreamResource, Institution, InstitutionConsent, IsoBankTransactionCode, IsoCodeDetails, Location, LocationOtherLocationCategory, Media, Merchant, MerchantInfo, MonitoringFeatureStatus, NewApplicationUser, Next, OneTimeTokenRequest, OtherApplicationFrequency, OtherBankInterestType, OtherCalculationFrequency, OtherFeeRateType, OtherFeeType, OtherResidencyType, OtherType, Overdraft, OverdraftOtherFeeType, OverdraftOverdraftFeeChargeCap, OverdraftOverdraftFeeChargeDetail, OverdraftOverdraftFeesCharges, OverdraftOverdraftFeesCharges1, OverdraftOverdraftTierBand, OverdraftOverdraftTierBandSet, Pagination, Payee, PaymentResponse, PaymentStatusDetails, PersonalCurrentAccountBrand, PersonalCurrentAccountData, PersonalCurrentAccountPCA, PersonalCurrentAccountPCAMarketingState, PostalAddress1, ProprietaryBankTransactionCode, ResidencyEligibility, ResponseEntity, ResponseListMeta, ResponseMeta, Site, SortCodePaymentAuthRequest, SortCodePaymentRequest, StatementReference, Transaction, TransferRequest, TransferResponse, URI, URL, UserDeleteResponse, YapilyAccessToken, AccountsApi, ApplicationUsersApi, ApplicationsApi, ConsentsApi, IdentityApi, InstitutionsApi, InstitutionsOpenDataApi, OAuthApi, PaymentsApi, StatementsApi, TransactionsApi, TransfersApi) {
  'use strict';
