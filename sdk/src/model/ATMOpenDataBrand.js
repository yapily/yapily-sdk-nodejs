...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ATMOpenDataATM'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ATMOpenDataATM'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.ATMOpenDataBrand = factory(root.YapilyApi.ApiClient, root.YapilyApi.ATMOpenDataATM);
  }
}(this, function(ApiClient, ATMOpenDataATM) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ATM')) {
        obj['ATM'] = ApiClient.convertToType(data['ATM'], [ATMOpenDataATM]);
      }
  ...
  /**
   * @member {Array.<module:model/ATMOpenDataATM>} ATM
   */
