...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountRequest', 'model/ScaMethod', 'model/UserCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountRequest'), require('./ScaMethod'), require('./UserCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.AccountEmbeddedAuthorisationRequest = factory(root.YapilyApi.ApiClient, root.YapilyApi.AccountRequest, root.YapilyApi.ScaMethod, root.YapilyApi.UserCredentials);
  }
}(this, function(ApiClient, AccountRequest, ScaMethod, UserCredentials) {
  'use strict';
