    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('paging')) {
                obj['paging'] = FilteredClientPayloadListAccountStatement.constructFromObject(data['paging']);
            }
 ...
 */
ApiListResponseOfAccountStatement.prototype['forwardedData'] = undefined;

/**
 * @member {Array.<module:model/RawResponse>} raw
 */
ApiListResponseOfAccountStatement.prototype['raw'] = undefined;

/**
 * @member {module:model/FilteredClientPayloadListAccountStatement} paging
 */
ApiListResponseOfAccountStatement.prototype['paging'] = undefined;

/**
 * @member {String} tracingId
 */
ApiListResponseOfAccountStatement.prototype['tracingId'] = undefined;
