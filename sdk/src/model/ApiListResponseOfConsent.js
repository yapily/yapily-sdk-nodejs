    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('paging')) {
                obj['paging'] = FilteredClientPayloadListConsent.constructFromObject(data['paging']);
            }
 ...
 */
ApiListResponseOfConsent.prototype['forwardedData'] = undefined;

/**
 * @member {Array.<module:model/RawResponse>} raw
 */
ApiListResponseOfConsent.prototype['raw'] = undefined;

/**
 * @member {module:model/FilteredClientPayloadListConsent} paging
 */
ApiListResponseOfConsent.prototype['paging'] = undefined;

/**
 * @member {String} tracingId
 */
ApiListResponseOfConsent.prototype['tracingId'] = undefined;
