...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureDetails', 'model/ResponseMeta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FeatureDetails'), require('./ResponseMeta'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.ApiListResponseOfFeatureDetails = factory(root.YapilyApi.ApiClient, root.YapilyApi.FeatureDetails, root.YapilyApi.ResponseMeta);
  }
}(this, function(ApiClient, FeatureDetails, ResponseMeta) {
  'use strict';
