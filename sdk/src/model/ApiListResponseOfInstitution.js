...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Institution', 'model/ResponseListMeta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Institution'), require('./ResponseListMeta'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.ApiListResponseOfInstitution = factory(root.YapilyApi.ApiClient, root.YapilyApi.Institution, root.YapilyApi.ResponseListMeta);
  }
}(this, function(ApiClient, Institution, ResponseListMeta) {
  'use strict';
