...
/**
 * The ApiResponseError model module.
 * @module model/ApiResponseError
 * @version 2.13.1
 */
class ApiResponseError {
    /**
     * Constructs a new <code>ApiResponseError</code>.
     ...
     * @alias module:model/ApiResponseError
     */
    constructor() { 
        
        ApiResponseError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiResponseError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiResponseError} obj Optional instance to populate.
     * @return {module:model/ApiResponseError} The populated <code>ApiResponseError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiResponseError();
 ...
 */
ApiResponseError.prototype['error'] = undefined;

/**
 * @member {Array.<module:model/MonitoringEndpointStatus>} monitoring
 */
ApiResponseError.prototype['monitoring'] = undefined;

/**
 * @member {Array.<module:model/RawResponse>} raw
 */
ApiResponseError.prototype['raw'] = undefined;
