...
class ApiResponseOfBalances {
    ...
    constructor() { 
        ...
        ApiResponseOfBalances.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiResponseOfBalances();
 ...
 */
ApiResponseOfBalances.prototype['meta'] = undefined;

/**
 * @member {module:model/Balances} data
 */
ApiResponseOfBalances.prototype['data'] = undefined;

/**
 * @member {Object.<String, String>} links
 */
ApiResponseOfBalances.prototype['links'] = undefined;

/**
 * @member {Array.<module:model/ResponseForwardedData>} forwardedData
 */
ApiResponseOfBalances.prototype['forwardedData'] = undefined;

/**
 * @member {Array.<module:model/RawResponse>} raw
 */
ApiResponseOfBalances.prototype['raw'] = undefined;

/**
 * @member {String} tracingId
 */
ApiResponseOfBalances.prototype['tracingId'] = undefined;
...
export default ApiResponseOfBalances;
