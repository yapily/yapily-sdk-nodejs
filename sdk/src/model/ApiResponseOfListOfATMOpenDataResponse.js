...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ATMOpenDataResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ATMOpenDataResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.ApiResponseOfListOfATMOpenDataResponse = factory(root.YapilyApi.ApiClient, root.YapilyApi.ATMOpenDataResponse);
  }
}(this, function(ApiClient, ATMOpenDataResponse) {
  'use strict';
