...
import PersonalCurrentAccountData from './PersonalCurrentAccountData';
...
class ApiResponseOfListOfPersonalCurrentAccountData {
    ...
    constructor() { 
        ...
        ApiResponseOfListOfPersonalCurrentAccountData.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiResponseOfListOfPersonalCurrentAccountData();
 ...
 */
ApiResponseOfListOfPersonalCurrentAccountData.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/PersonalCurrentAccountData>} data
 */
ApiResponseOfListOfPersonalCurrentAccountData.prototype['data'] = undefined;

/**
 * @member {Object.<String, String>} links
 */
ApiResponseOfListOfPersonalCurrentAccountData.prototype['links'] = undefined;
...
export default ApiResponseOfListOfPersonalCurrentAccountData;
