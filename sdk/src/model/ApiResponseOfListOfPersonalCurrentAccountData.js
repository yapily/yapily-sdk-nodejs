...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PersonalCurrentAccountData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PersonalCurrentAccountData'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.ApiResponseOfListOfPersonalCurrentAccountData = factory(root.YapilyApi.ApiClient, root.YapilyApi.PersonalCurrentAccountData);
  }
}(this, function(ApiClient, PersonalCurrentAccountData) {
  'use strict';
