...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentResponse', 'model/ResponseMeta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentResponse'), require('./ResponseMeta'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.ApiResponseOfPaymentResponse = factory(root.YapilyApi.ApiClient, root.YapilyApi.PaymentResponse, root.YapilyApi.ResponseMeta);
  }
}(this, function(ApiClient, PaymentResponse, ResponseMeta) {
  'use strict';
