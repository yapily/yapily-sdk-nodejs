...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ScaMethod'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ScaMethod'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.AuthorisationEmbeddedRequestResponse = factory(root.YapilyApi.ApiClient, root.YapilyApi.ScaMethod);
  }
}(this, function(ApiClient, ScaMethod) {
  'use strict';
  ...
  /**
   * Constructs a new <code>AuthorisationEmbeddedRequestResponse</code>.
   * @alias module:model/AuthorisationEmbeddedRequestResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AuthorisationEmbeddedRequestResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AuthorisationEmbeddedRequestResponse} obj Optional instance to populate.
   * @return {module:model/AuthorisationEmbeddedRequestResponse} The populated <code>AuthorisationEmbeddedRequestResponse</code> instance.
   */
  ...
  /**
   * @member {module:model/AuthorisationEmbeddedRequestResponse.StatusEnum} status
   */
  ...
  /**
   * @member {Array.<module:model/AuthorisationEmbeddedRequestResponse.FeatureScopeEnum>} featureScope
   */
