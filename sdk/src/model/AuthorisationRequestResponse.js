...
class AuthorisationRequestResponse {
    ...
    constructor() { 
        ...
        AuthorisationRequestResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthorisationRequestResponse();
 ...
 * @member {String} id
 */
AuthorisationRequestResponse.prototype['id'] = undefined;

/**
 * @member {String} userUuid
 */
AuthorisationRequestResponse.prototype['userUuid'] = undefined;

/**
 * @member {String} applicationUserId
 */
AuthorisationRequestResponse.prototype['applicationUserId'] = undefined;

/**
 * @member {String} referenceId
 */
AuthorisationRequestResponse.prototype['referenceId'] = undefined;

/**
 * @member {String} institutionId
 */
AuthorisationRequestResponse.prototype['institutionId'] = undefined;

/**
 * @member {module:model/AuthorisationRequestResponse.StatusEnum} status
 */
AuthorisationRequestResponse.prototype['status'] = undefined;

/**
 * @member {Date} createdAt
 */
AuthorisationRequestResponse.prototype['createdAt'] = undefined;

/**
 * @member {Date} transactionFrom
 */
AuthorisationRequestResponse.prototype['transactionFrom'] = undefined;

/**
 * @member {Date} transactionTo
 */
AuthorisationRequestResponse.prototype['transactionTo'] = undefined;

/**
 * @member {Date} expiresAt
 */
AuthorisationRequestResponse.prototype['expiresAt'] = undefined;

/**
 * Deprecated. Use `timeToExpire` instead.
 * @member {Number} timeToExpireInMillis
 */
AuthorisationRequestResponse.prototype['timeToExpireInMillis'] = undefined;

/**
 * ISO 8601 duration
 * @member {String} timeToExpire
 */
AuthorisationRequestResponse.prototype['timeToExpire'] = undefined;

/**
 * @member {Array.<module:model/AuthorisationRequestResponse.FeatureScopeEnum>} featureScope
 */
AuthorisationRequestResponse.prototype['featureScope'] = undefined;

/**
 * @member {Date} startsAt
 */
AuthorisationRequestResponse.prototype['startsAt'] = undefined;

/**
 * @member {Number} totalMaxAmount
 */
AuthorisationRequestResponse.prototype['totalMaxAmount'] = undefined;

/**
 * @member {Number} maxAmountPerRequest
 */
AuthorisationRequestResponse.prototype['maxAmountPerRequest'] = undefined;

/**
 * @member {Boolean} allowOverdraft
 */
AuthorisationRequestResponse.prototype['allowOverdraft'] = undefined;

/**
 * @member {String} consentToken
 */
AuthorisationRequestResponse.prototype['consentToken'] = undefined;

/**
 * @member {String} authorisationUrl
 */
AuthorisationRequestResponse.prototype['authorisationUrl'] = undefined;
 ...
 * @readonly
 */
AuthorisationRequestResponse['StatusEnum'] = {
 ...
 * @readonly
 */
AuthorisationRequestResponse['FeatureScopeEnum'] = {
...
export default AuthorisationRequestResponse;
