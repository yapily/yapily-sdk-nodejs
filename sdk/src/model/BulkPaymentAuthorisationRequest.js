...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BulkPaymentRequest', 'model/RedirectRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BulkPaymentRequest'), require('./RedirectRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.BulkPaymentAuthorisationRequest = factory(root.YapilyApi.ApiClient, root.YapilyApi.BulkPaymentRequest, root.YapilyApi.RedirectRequest);
  }
}(this, function(ApiClient, BulkPaymentRequest, RedirectRequest) {
  'use strict';
