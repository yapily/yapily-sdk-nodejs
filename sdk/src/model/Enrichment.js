...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Categorisation', 'model/Merchant', 'model/TransactionHash'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Categorisation'), require('./Merchant'), require('./TransactionHash'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.Enrichment = factory(root.YapilyApi.ApiClient, root.YapilyApi.Categorisation, root.YapilyApi.Merchant, root.YapilyApi.TransactionHash);
  }
}(this, function(ApiClient, Categorisation, Merchant, TransactionHash) {
  'use strict';
