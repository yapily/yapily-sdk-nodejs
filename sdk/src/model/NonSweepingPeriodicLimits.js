...
/**
 * The NonSweepingPeriodicLimits model module.
 * @module model/NonSweepingPeriodicLimits
 * @version 2.13.1
 */
class NonSweepingPeriodicLimits {
    /**
     * Constructs a new <code>NonSweepingPeriodicLimits</code>.
     * @alias module:model/NonSweepingPeriodicLimits
    ...
    constructor(totalMaxAmount, frequency, alignment) { 
        ...
        NonSweepingPeriodicLimits.initialize(this, totalMaxAmount, frequency, alignment);
    }
    ...
    /**
     * Constructs a <code>NonSweepingPeriodicLimits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NonSweepingPeriodicLimits} obj Optional instance to populate.
     * @return {module:model/NonSweepingPeriodicLimits} The populated <code>NonSweepingPeriodicLimits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NonSweepingPeriodicLimits();
            ...
            if (data.hasOwnProperty('maxNumberOfPayments')) {
                obj['maxNumberOfPayments'] = ApiClient.convertToType(data['maxNumberOfPayments'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
NonSweepingPeriodicLimits.prototype['totalMaxAmount'] = undefined;
 ...
 */
NonSweepingPeriodicLimits.prototype['frequency'] = undefined;
 ...
 */
NonSweepingPeriodicLimits.prototype['alignment'] = undefined;

/**
 * __Optional__. Max number of payments that can be submitted under this period.
 * @member {Number} maxNumberOfPayments
 */
NonSweepingPeriodicLimits.prototype['maxNumberOfPayments'] = undefined;
...
export default NonSweepingPeriodicLimits;
