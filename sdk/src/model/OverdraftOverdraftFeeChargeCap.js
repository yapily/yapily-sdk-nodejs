...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('FeeMinMaxType')) {
        obj['FeeMinMaxType'] = ApiClient.convertToType(data['FeeMinMaxType'], 'String');
      }
  ...
  /**
   * @member {module:model/OverdraftOverdraftFeeChargeCap.FeeMinMaxTypeEnum} FeeMinMaxType
   */
  exports.prototype['FeeMinMaxType'] = undefined;
  /**
  ...
  /**
   * Allowed values for the <code>FeeMinMaxType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.FeeMinMaxTypeEnum = {
    /**
     * value: "Minimum"
     * @const
     */
