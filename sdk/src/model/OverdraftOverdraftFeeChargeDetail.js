...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OtherApplicationFrequency', 'model/OtherCalculationFrequency', 'model/OtherFeeRateType', 'model/OtherFeeType', 'model/OverdraftFeeApplicableRange'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OtherApplicationFrequency'), require('./OtherCalculationFrequency'), require('./OtherFeeRateType'), require('./OtherFeeType'), require('./OverdraftFeeApplicableRange'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.OverdraftOverdraftFeeChargeDetail = factory(root.YapilyApi.ApiClient, root.YapilyApi.OtherApplicationFrequency, root.YapilyApi.OtherCalculationFrequency, root.YapilyApi.OtherFeeRateType, root.YapilyApi.OtherFeeType, root.YapilyApi.OverdraftFeeApplicableRange);
  }
}(this, function(ApiClient, OtherApplicationFrequency, OtherCalculationFrequency, OtherFeeRateType, OtherFeeType, OverdraftFeeApplicableRange) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('OverdraftFeeApplicableRange')) {
        obj['OverdraftFeeApplicableRange'] = OverdraftFeeApplicableRange.constructFromObject(data['OverdraftFeeApplicableRange']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/OverdraftFeeApplicableRange} OverdraftFeeApplicableRange
   */
  exports.prototype['OverdraftFeeApplicableRange'] = undefined;
