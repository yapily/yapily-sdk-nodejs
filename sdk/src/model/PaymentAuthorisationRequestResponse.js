...
class PaymentAuthorisationRequestResponse {
    /**
     * Constructs a new <code>PaymentAuthorisationRequestResponse</code>.
     * @alias module:model/PaymentAuthorisationRequestResponse
     */
    constructor() { 
        
        PaymentAuthorisationRequestResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentAuthorisationRequestResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentAuthorisationRequestResponse} obj Optional instance to populate.
     * @return {module:model/PaymentAuthorisationRequestResponse} The populated <code>PaymentAuthorisationRequestResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentAuthorisationRequestResponse();
 ...
 * @member {String} id
 */
PaymentAuthorisationRequestResponse.prototype['id'] = undefined;

/**
 * @member {String} userUuid
 */
PaymentAuthorisationRequestResponse.prototype['userUuid'] = undefined;

/**
 * @member {String} applicationUserId
 */
PaymentAuthorisationRequestResponse.prototype['applicationUserId'] = undefined;

/**
 * @member {String} referenceId
 */
PaymentAuthorisationRequestResponse.prototype['referenceId'] = undefined;

/**
 * @member {String} institutionId
 */
PaymentAuthorisationRequestResponse.prototype['institutionId'] = undefined;

/**
 * @member {module:model/AuthorisationStatus} status
 */
PaymentAuthorisationRequestResponse.prototype['status'] = undefined;

/**
 * @member {Date} createdAt
 */
PaymentAuthorisationRequestResponse.prototype['createdAt'] = undefined;

/**
 * @member {Date} transactionFrom
 */
PaymentAuthorisationRequestResponse.prototype['transactionFrom'] = undefined;

/**
 * @member {Date} transactionTo
 */
PaymentAuthorisationRequestResponse.prototype['transactionTo'] = undefined;

/**
 * @member {Date} expiresAt
 */
PaymentAuthorisationRequestResponse.prototype['expiresAt'] = undefined;

/**
 * @member {Number} timeToExpireInMillis
 */
PaymentAuthorisationRequestResponse.prototype['timeToExpireInMillis'] = undefined;

/**
 * @member {String} timeToExpire
 */
PaymentAuthorisationRequestResponse.prototype['timeToExpire'] = undefined;

/**
 * @member {Array.<module:model/FeatureEnum>} featureScope
 */
PaymentAuthorisationRequestResponse.prototype['featureScope'] = undefined;

/**
 * @member {String} consentToken
 */
PaymentAuthorisationRequestResponse.prototype['consentToken'] = undefined;

/**
 * @member {String} state
 */
PaymentAuthorisationRequestResponse.prototype['state'] = undefined;

/**
 * @member {Date} authorizedAt
 */
PaymentAuthorisationRequestResponse.prototype['authorizedAt'] = undefined;

/**
 * @member {String} institutionConsentId
 */
PaymentAuthorisationRequestResponse.prototype['institutionConsentId'] = undefined;

/**
 * @member {Array.<module:model/PaymentChargeDetails>} charges
 */
PaymentAuthorisationRequestResponse.prototype['charges'] = undefined;

/**
 * @member {module:model/ExchangeRateInformationResponse} exchangeRateInformation
 */
PaymentAuthorisationRequestResponse.prototype['exchangeRateInformation'] = undefined;

/**
 * @member {String} authorisationUrl
 */
PaymentAuthorisationRequestResponse.prototype['authorisationUrl'] = undefined;

/**
 * @member {String} qrCodeUrl
 */
PaymentAuthorisationRequestResponse.prototype['qrCodeUrl'] = undefined;

/**
 * @member {String} explanation
 */
PaymentAuthorisationRequestResponse.prototype['explanation'] = undefined;
...
export default PaymentAuthorisationRequestResponse;
