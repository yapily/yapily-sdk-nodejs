...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentRequest', 'model/ScaMethod', 'model/UserCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentRequest'), require('./ScaMethod'), require('./UserCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.PaymentEmbeddedAuthorisationRequest = factory(root.YapilyApi.ApiClient, root.YapilyApi.PaymentRequest, root.YapilyApi.ScaMethod, root.YapilyApi.UserCredentials);
  }
}(this, function(ApiClient, PaymentRequest, ScaMethod, UserCredentials) {
  'use strict';
