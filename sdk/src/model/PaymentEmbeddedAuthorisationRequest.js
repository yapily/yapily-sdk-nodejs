...
/**
 * The PaymentEmbeddedAuthorisationRequest model module.
 * @module model/PaymentEmbeddedAuthorisationRequest
 * @version 2.13.1
 */
class PaymentEmbeddedAuthorisationRequest {
    /**
     * Constructs a new <code>PaymentEmbeddedAuthorisationRequest</code>.
     * The request body containing an &#x60;PaymentEmbeddedAuthorisationRequest&#x60; json payload
     * @alias module:model/PaymentEmbeddedAuthorisationRequest
    ...
    constructor(institutionId, paymentRequest) { 
        ...
        PaymentEmbeddedAuthorisationRequest.initialize(this, institutionId, paymentRequest);
    }
    ...
    /**
     * Constructs a <code>PaymentEmbeddedAuthorisationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentEmbeddedAuthorisationRequest} obj Optional instance to populate.
     * @return {module:model/PaymentEmbeddedAuthorisationRequest} The populated <code>PaymentEmbeddedAuthorisationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentEmbeddedAuthorisationRequest();
 ...
 */
PaymentEmbeddedAuthorisationRequest.prototype['userUuid'] = undefined;
 ...
 */
PaymentEmbeddedAuthorisationRequest.prototype['applicationUserId'] = undefined;
 ...
 */
PaymentEmbeddedAuthorisationRequest.prototype['institutionId'] = undefined;
 ...
 */
PaymentEmbeddedAuthorisationRequest.prototype['callback'] = undefined;

/**
 * @member {module:model/RedirectRequest} redirect
 */
PaymentEmbeddedAuthorisationRequest.prototype['redirect'] = undefined;
 ...
 */
PaymentEmbeddedAuthorisationRequest.prototype['oneTimeToken'] = undefined;

/**
 * @member {module:model/PaymentRequest} paymentRequest
 */
PaymentEmbeddedAuthorisationRequest.prototype['paymentRequest'] = undefined;

/**
 * @member {module:model/UserCredentials} userCredentials
 */
PaymentEmbeddedAuthorisationRequest.prototype['userCredentials'] = undefined;

/**
 * @member {module:model/ScaMethod} selectedScaMethod
 */
PaymentEmbeddedAuthorisationRequest.prototype['selectedScaMethod'] = undefined;
 ...
 */
PaymentEmbeddedAuthorisationRequest.prototype['scaCode'] = undefined;
...
export default PaymentEmbeddedAuthorisationRequest;
