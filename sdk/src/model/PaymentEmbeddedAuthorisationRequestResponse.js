...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ChargeDetails', 'model/ExchangeRateInformationResponse', 'model/ScaMethod'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ChargeDetails'), require('./ExchangeRateInformationResponse'), require('./ScaMethod'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.PaymentEmbeddedAuthorisationRequestResponse = factory(root.YapilyApi.ApiClient, root.YapilyApi.ChargeDetails, root.YapilyApi.ExchangeRateInformationResponse, root.YapilyApi.ScaMethod);
  }
}(this, function(ApiClient, ChargeDetails, ExchangeRateInformationResponse, ScaMethod) {
  'use strict';
  ...
  /**
   * @member {module:model/PaymentEmbeddedAuthorisationRequestResponse.StatusEnum} status
   */
  ...
  /**
   * @member {Array.<module:model/PaymentEmbeddedAuthorisationRequestResponse.FeatureScopeEnum>} featureScope
   */
   ...
   */
  exports.prototype['scaMethods'] = undefined;
  /**
