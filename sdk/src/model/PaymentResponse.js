...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('firstPaymentAmountDetails')) {
        obj['firstPaymentAmountDetails'] = Amount.constructFromObject(data['firstPaymentAmountDetails']);
      }
      ...
      if (data.hasOwnProperty('nextPaymentAmountDetails')) {
        obj['nextPaymentAmountDetails'] = Amount.constructFromObject(data['nextPaymentAmountDetails']);
      }
      if (data.hasOwnProperty('nextPaymentDateTime')) {
        obj['nextPaymentDateTime'] = ApiClient.convertToType(data['nextPaymentDateTime'], 'Date');
      }
      if (data.hasOwnProperty('finalPaymentAmountDetails')) {
        obj['finalPaymentAmountDetails'] = Amount.constructFromObject(data['finalPaymentAmountDetails']);
      }
      ...
      if (data.hasOwnProperty('previousPaymentAmountDetails')) {
        obj['previousPaymentAmountDetails'] = Amount.constructFromObject(data['previousPaymentAmountDetails']);
      }
      ...
      if (data.hasOwnProperty('frequencyDetails')) {
        obj['frequencyDetails'] = FrequencyResponse.constructFromObject(data['frequencyDetails']);
      }
  ...
  /**
   * @member {module:model/Amount} firstPaymentAmountDetails
   */
  exports.prototype['firstPaymentAmountDetails'] = undefined;
  /**
   * @member {Date} firstPaymentDateTime
   */
  exports.prototype['firstPaymentDateTime'] = undefined;
  /**
   * @member {module:model/Amount} nextPaymentAmountDetails
   */
  exports.prototype['nextPaymentAmountDetails'] = undefined;
  /**
   * @member {Date} nextPaymentDateTime
   */
  exports.prototype['nextPaymentDateTime'] = undefined;
  /**
   * @member {module:model/Amount} finalPaymentAmountDetails
   */
  exports.prototype['finalPaymentAmountDetails'] = undefined;
  /**
  ...
  /**
   * @member {module:model/Amount} previousPaymentAmountDetails
   */
  exports.prototype['previousPaymentAmountDetails'] = undefined;
  /**
  ...
  /**
   * @member {module:model/FrequencyResponse} frequencyDetails
   */
  exports.prototype['frequencyDetails'] = undefined;
  /**
