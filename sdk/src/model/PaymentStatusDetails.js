...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MultiAuthorisation', 'model/PaymentIsoStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MultiAuthorisation'), require('./PaymentIsoStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.PaymentStatusDetails = factory(root.YapilyApi.ApiClient, root.YapilyApi.MultiAuthorisation, root.YapilyApi.PaymentIsoStatus);
  }
}(this, function(ApiClient, MultiAuthorisation, PaymentIsoStatus) {
  'use strict';
   ...
   */
  exports.prototype['isoStatus'] = undefined;
