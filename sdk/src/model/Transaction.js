...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressDetails', 'model/Balance', 'model/ChargeDetails', 'model/CurrencyExchange', 'model/Enrichment', 'model/IsoBankTransactionCode', 'model/Merchant', 'model/ProprietaryBankTransactionCode', 'model/StatementReference', 'model/TransactionAmount'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AddressDetails'), require('./Balance'), require('./ChargeDetails'), require('./CurrencyExchange'), require('./Enrichment'), require('./IsoBankTransactionCode'), require('./Merchant'), require('./ProprietaryBankTransactionCode'), require('./StatementReference'), require('./TransactionAmount'));
  } else {
    // Browser globals (root is window)
    if (!root.YapilyApi) {
      root.YapilyApi = {};
    }
    root.YapilyApi.Transaction = factory(root.YapilyApi.ApiClient, root.YapilyApi.AddressDetails, root.YapilyApi.Balance, root.YapilyApi.ChargeDetails, root.YapilyApi.CurrencyExchange, root.YapilyApi.Enrichment, root.YapilyApi.IsoBankTransactionCode, root.YapilyApi.Merchant, root.YapilyApi.ProprietaryBankTransactionCode, root.YapilyApi.StatementReference, root.YapilyApi.TransactionAmount);
  }
}(this, function(ApiClient, AddressDetails, Balance, ChargeDetails, CurrencyExchange, Enrichment, IsoBankTransactionCode, Merchant, ProprietaryBankTransactionCode, StatementReference, TransactionAmount) {
  'use strict';
