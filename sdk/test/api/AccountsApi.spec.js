...
(function(root, factory) {
  ...
  describe('AccountsApi', function() {
    ...
    describe('getAccountPeriodicPaymentOrderUsingGET', function() {
      it('should call getAccountPeriodicPaymentOrderUsingGET successfully', function(done) {
        //uncomment below and update the code to test getAccountPeriodicPaymentOrderUsingGET
        //instance.getAccountPeriodicPaymentOrderUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
