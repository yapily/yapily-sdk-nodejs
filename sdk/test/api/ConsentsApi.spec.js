...
(function(root, factory) {
  ...
  describe('ConsentsApi', function() {
    ...
    describe('createPreAuthorisationRequestUsingPOST', function() {
      it('should call createPreAuthorisationRequestUsingPOST successfully', function(done) {
        //uncomment below and update the code to test createPreAuthorisationRequestUsingPOST
        //instance.createPreAuthorisationRequestUsingPOST(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
