...
(function(root, factory) {
  ...
  describe('InstitutionsApi', function() {
    describe('getFeatureDetailsUsingGET', function() {
      it('should call getFeatureDetailsUsingGET successfully', function(done) {
        //uncomment below and update the code to test getFeatureDetailsUsingGET
        //instance.getFeatureDetailsUsingGET(function(error) {
