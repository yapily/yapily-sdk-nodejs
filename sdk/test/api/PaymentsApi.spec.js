...
(function(root, factory) {
  ...
  describe('PaymentsApi', function() {
    describe('createBulkPayment', function() {
      it('should call createBulkPayment successfully', function(done) {
        //uncomment below and update the code to test createBulkPayment
        //instance.createBulkPayment(function(error) {
