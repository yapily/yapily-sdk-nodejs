...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.ATMOpenDataATM();
  });
  ...
  describe('ATMOpenDataATM', function() {
    it('should create an instance of ATMOpenDataATM', function() {
      // uncomment below and update the code to test ATMOpenDataATM
      //var instane = new YapilyApi.ATMOpenDataATM();
      //expect(instance).to.be.a(YapilyApi.ATMOpenDataATM);
    });
