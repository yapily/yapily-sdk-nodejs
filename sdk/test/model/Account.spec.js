...
(function(root, factory) {
  ...
  describe('Account', function() {
    ...
    it('should have the property consolidatedAccountInformation (base name: "consolidatedAccountInformation")', function() {
      // uncomment below and update the code to test the property consolidatedAccountInformation
      //var instance = new YapilyApi.Account();
      //expect(instance).to.be();
    });
