...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.AccountAuthorisationResponse();
  });
  ...
  describe('AccountAuthorisationResponse', function() {
    it('should create an instance of AccountAuthorisationResponse', function() {
      // uncomment below and update the code to test AccountAuthorisationResponse
      //var instance = new YapilyApi.AccountAuthorisationResponse();
      //expect(instance).to.be.a(YapilyApi.AccountAuthorisationResponse);
    });
    ...
    it('should have the property lastConfirmedAt (base name: "lastConfirmedAt")', function() {
      // uncomment below and update the code to test the property lastConfirmedAt
      //var instance = new YapilyApi.AccountAuthorisationResponse();
      //expect(instance).to.be();
    });

    it('should have the property reconfirmBy (base name: "reconfirmBy")', function() {
      // uncomment below and update the code to test the property reconfirmBy
      //var instance = new YapilyApi.AccountAuthorisationResponse();
      //expect(instance).to.be();
    });
