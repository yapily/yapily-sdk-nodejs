...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.AccountEmbeddedAuthorisationRequest();
  });
  ...
  describe('AccountEmbeddedAuthorisationRequest', function() {
    it('should create an instance of AccountEmbeddedAuthorisationRequest', function() {
      // uncomment below and update the code to test AccountEmbeddedAuthorisationRequest
      //var instance = new YapilyApi.AccountEmbeddedAuthorisationRequest();
      //expect(instance).to.be.a(YapilyApi.AccountEmbeddedAuthorisationRequest);
    });
