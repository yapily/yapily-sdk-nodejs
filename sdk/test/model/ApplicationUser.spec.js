...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyRestApiExplorer.ApplicationUser();
  });
  ...
  describe('ApplicationUser', function() {
    it('should create an instance of ApplicationUser', function() {
      ...
      //var instane = new YapilyRestApiExplorer.ApplicationUser();
      //expect(instance).to.be.a(YapilyRestApiExplorer.ApplicationUser);
    });
