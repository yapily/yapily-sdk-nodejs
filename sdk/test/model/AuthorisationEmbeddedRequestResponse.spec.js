...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.AuthorisationEmbeddedRequestResponse();
  });
  ...
  describe('AuthorisationEmbeddedRequestResponse', function() {
    it('should create an instance of AuthorisationEmbeddedRequestResponse', function() {
      // uncomment below and update the code to test AuthorisationEmbeddedRequestResponse
      //var instance = new YapilyApi.AuthorisationEmbeddedRequestResponse();
      //expect(instance).to.be.a(YapilyApi.AuthorisationEmbeddedRequestResponse);
    });
