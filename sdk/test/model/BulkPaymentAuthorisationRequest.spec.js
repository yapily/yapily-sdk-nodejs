...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.BulkPaymentAuthorisationRequest();
  });
  ...
  describe('BulkPaymentAuthorisationRequest', function() {
    it('should create an instance of BulkPaymentAuthorisationRequest', function() {
      // uncomment below and update the code to test BulkPaymentAuthorisationRequest
      //var instance = new YapilyApi.BulkPaymentAuthorisationRequest();
      //expect(instance).to.be.a(YapilyApi.BulkPaymentAuthorisationRequest);
    });
