...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.EmbeddedAccountAuthorisationRequest();
  });
  ...
  describe('EmbeddedAccountAuthorisationRequest', function() {
    it('should create an instance of EmbeddedAccountAuthorisationRequest', function() {
      // uncomment below and update the code to test EmbeddedAccountAuthorisationRequest
      //var instance = new YapilyApi.EmbeddedAccountAuthorisationRequest();
      //expect(instance).to.be.a(YapilyApi.EmbeddedAccountAuthorisationRequest);
    });
