...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.EmbeddedAccountAuthorisationResponse();
  });
  ...
  describe('EmbeddedAccountAuthorisationResponse', function() {
    it('should create an instance of EmbeddedAccountAuthorisationResponse', function() {
      // uncomment below and update the code to test EmbeddedAccountAuthorisationResponse
      //var instance = new YapilyApi.EmbeddedAccountAuthorisationResponse();
      //expect(instance).to.be.a(YapilyApi.EmbeddedAccountAuthorisationResponse);
    });
