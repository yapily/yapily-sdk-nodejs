...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.EnrichedTransaction();
  });
  ...
  describe('EnrichedTransaction', function() {
    it('should create an instance of EnrichedTransaction', function() {
      // uncomment below and update the code to test EnrichedTransaction
      //var instance = new YapilyApi.EnrichedTransaction();
      //expect(instance).to.be.a(YapilyApi.EnrichedTransaction);
    });
