...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.ErrorIssue();
  });
  ...
  describe('ErrorIssue', function() {
    it('should create an instance of ErrorIssue', function() {
      // uncomment below and update the code to test ErrorIssue
      //var instance = new YapilyApi.ErrorIssue();
      //expect(instance).to.be.a(YapilyApi.ErrorIssue);
    });
