...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyRestApiExplorer.Institution();
  });
  ...
  describe('Institution', function() {
    it('should create an instance of Institution', function() {
      ...
      //var instane = new YapilyRestApiExplorer.Institution();
      //expect(instance).to.be.a(YapilyRestApiExplorer.Institution);
    });
    ...
    it('should have the property implemented (base name: "implemented")', function() {
      // uncomment below and update the code to test the property implemented
      //var instane = new YapilyRestApiExplorer.Institution();
      //expect(instance).to.be();
    });
