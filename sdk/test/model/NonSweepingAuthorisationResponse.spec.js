...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.NonSweepingAuthorisationResponse();
  });
  ...
  describe('NonSweepingAuthorisationResponse', function() {
    it('should create an instance of NonSweepingAuthorisationResponse', function() {
      // uncomment below and update the code to test NonSweepingAuthorisationResponse
      //var instance = new YapilyApi.NonSweepingAuthorisationResponse();
      //expect(instance).to.be.a(YapilyApi.NonSweepingAuthorisationResponse);
    });
