...
(function(root, factory) {
  ...
  describe('OverdraftOverdraftFeeChargeDetail', function() {
    ...
    it('should have the property overdraftFeeApplicableRange (base name: "OverdraftFeeApplicableRange")', function() {
      // uncomment below and update the code to test the property overdraftFeeApplicableRange
      //var instane = new YapilyApi.OverdraftOverdraftFeeChargeDetail();
      //expect(instance).to.be();
    });
