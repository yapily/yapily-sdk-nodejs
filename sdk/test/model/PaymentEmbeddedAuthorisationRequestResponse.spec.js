...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.PaymentEmbeddedAuthorisationRequestResponse();
  });
  ...
  describe('PaymentEmbeddedAuthorisationRequestResponse', function() {
    it('should create an instance of PaymentEmbeddedAuthorisationRequestResponse', function() {
      // uncomment below and update the code to test PaymentEmbeddedAuthorisationRequestResponse
      //var instance = new YapilyApi.PaymentEmbeddedAuthorisationRequestResponse();
      //expect(instance).to.be.a(YapilyApi.PaymentEmbeddedAuthorisationRequestResponse);
    });
