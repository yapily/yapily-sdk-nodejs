...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.PaymentPreAuthorisationRequest();
  });
  ...
  describe('PaymentPreAuthorisationRequest', function() {
    it('should create an instance of PaymentPreAuthorisationRequest', function() {
      // uncomment below and update the code to test PaymentPreAuthorisationRequest
      //var instance = new YapilyApi.PaymentPreAuthorisationRequest();
      //expect(instance).to.be.a(YapilyApi.PaymentPreAuthorisationRequest);
    });
