...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.RawResponse();
  });
  ...
  describe('RawResponse', function() {
    it('should create an instance of RawResponse', function() {
      // uncomment below and update the code to test RawResponse
      //var instance = new YapilyApi.RawResponse();
      //expect(instance).to.be.a(YapilyApi.RawResponse);
    });
