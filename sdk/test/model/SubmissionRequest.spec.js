...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.SubmissionRequest();
  });
  ...
  describe('SubmissionRequest', function() {
    it('should create an instance of SubmissionRequest', function() {
      // uncomment below and update the code to test SubmissionRequest
      //var instance = new YapilyApi.SubmissionRequest();
      //expect(instance).to.be.a(YapilyApi.SubmissionRequest);
    });
    ...
    it('should have the property psuAuthenticationMethod (base name: "psuAuthenticationMethod")', function() {
      // uncomment below and update the code to test the property psuAuthenticationMethod
      //var instance = new YapilyApi.SubmissionRequest();
      //expect(instance).to.be();
    });
