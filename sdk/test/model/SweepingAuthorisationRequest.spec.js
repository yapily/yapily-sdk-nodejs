...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.SweepingAuthorisationRequest();
  });
  ...
  describe('SweepingAuthorisationRequest', function() {
    it('should create an instance of SweepingAuthorisationRequest', function() {
      // uncomment below and update the code to test SweepingAuthorisationRequest
      //var instance = new YapilyApi.SweepingAuthorisationRequest();
      //expect(instance).to.be.a(YapilyApi.SweepingAuthorisationRequest);
    });
