...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.SweepingPeriodicLimits();
  });
  ...
  describe('SweepingPeriodicLimits', function() {
    it('should create an instance of SweepingPeriodicLimits', function() {
      // uncomment below and update the code to test SweepingPeriodicLimits
      //var instance = new YapilyApi.SweepingPeriodicLimits();
      //expect(instance).to.be.a(YapilyApi.SweepingPeriodicLimits);
    });
