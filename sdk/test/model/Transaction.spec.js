...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyRestApiExplorer.Transaction();
  });
  ...
  describe('Transaction', function() {
    it('should create an instance of Transaction', function() {
      ...
      //var instane = new YapilyRestApiExplorer.Transaction();
      //expect(instance).to.be.a(YapilyRestApiExplorer.Transaction);
    });
