...
(function(root, factory) {
  ...
  describe('Transaction', function() {
    ...
    it('should have the property transactionMutability (base name: "transactionMutability")', function() {
      // uncomment below and update the code to test the property transactionMutability
      //var instance = new YapilyApi.Transaction();
      //expect(instance).to.be();
    });
