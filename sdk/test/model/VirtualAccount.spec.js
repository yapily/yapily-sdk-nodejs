...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.VirtualAccount();
  });
  ...
  describe('VirtualAccount', function() {
    it('should create an instance of VirtualAccount', function() {
      // uncomment below and update the code to test VirtualAccount
      //var instance = new YapilyApi.VirtualAccount();
      //expect(instance).to.be.a(YapilyApi.VirtualAccount);
    });
