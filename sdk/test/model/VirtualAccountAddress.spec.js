...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.VirtualAccountAddress();
  });
  ...
  describe('VirtualAccountAddress', function() {
    it('should create an instance of VirtualAccountAddress', function() {
      // uncomment below and update the code to test VirtualAccountAddress
      //var instance = new YapilyApi.VirtualAccountAddress();
      //expect(instance).to.be.a(YapilyApi.VirtualAccountAddress);
    });
