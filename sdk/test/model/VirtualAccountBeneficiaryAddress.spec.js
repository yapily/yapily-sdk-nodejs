...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YapilyApi.VirtualAccountBeneficiaryAddress();
  });
  ...
  describe('VirtualAccountBeneficiaryAddress', function() {
    it('should create an instance of VirtualAccountBeneficiaryAddress', function() {
      // uncomment below and update the code to test VirtualAccountBeneficiaryAddress
      //var instance = new YapilyApi.VirtualAccountBeneficiaryAddress();
      //expect(instance).to.be.a(YapilyApi.VirtualAccountBeneficiaryAddress);
    });
